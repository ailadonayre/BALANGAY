...
<section class="relative h-[70vh] md:h-[80vh] lg:h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img data-src="{{ asset('assets/hero/hero.png') }}" loading="lazy" decoding="async" alt="BALANGAY Heritage" class="w-full h-full object-cover object-center lazy" id="hero-image">
        <div class="absolute inset-0 bg-gradient-to-b from-black/40 via-black/30 to-black/50"></div>
    </div>

    <!-- Content -->
    <div class="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto pt-20 reveal">
        ...
        <p class="text-sm sm:text-base md:text-lg text-white/90 mb-8 futura-400 max-w-2xl mx-auto leading-relaxed reveal">
        ...
        <a href="#discover" class="inline-block bg-white text-[#5B5843] px-8 md:px-12 py-3 md:py-4 rounded-full text-xs md:text-sm tracking-widest uppercase futura-500 hover:bg-[#E4DDCC] transition-all duration-300 transform hover:scale-105 reveal">
            Explore
        </a>
    </div>
