<nav class="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200/50 transition-all duration-300" id="main-nav">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            <!-- Left Navigation -->
            <div class="hidden md:flex items-center space-x-8 futura-400">
            ...
            <div class="flex items-center space-x-6">
                ...
                <button class="text-gray-700 hover:text-[#5B5843] transition-colors duration-300" aria-label="Account" onclick="document.getElementById('auth-modal').classList.remove('hidden')">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                </button>
                <button class="text-gray-700 hover:text-[#5B5843] transition-colors duration-300 relative" aria-label="Cart">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                    </svg>
                    <span class="absolute -top-2 -right-2 bg-[#5B5843] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center futura-500">0</span>
                </button>
    ...
    <div class="md:hidden hidden bg-white border-t border-gray-200" id="mobile-menu">
        <div class="px-6 py-4 space-y-3">
            <a href="#discover" class="block text-sm tracking-wide text-gray-700 hover:text-[#5B5843] uppercase futura-400">Discover</a>
            <a href="#shop" class="block text-sm tracking-wide text-gray-700 hover:text-[#5B5843] uppercase futura-400">Shop</a>
            <a href="#stories" class="block text-sm tracking-wide text-gray-700 hover:text-[#5B5843] uppercase futura-400">Stories</a>
            <a href="#support" class="block text-sm tracking-wide text-gray-700 hover:text-[#5B5843] uppercase futura-400">Support</a>
        </div>
    </div>
</nav>
