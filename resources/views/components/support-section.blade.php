<section class="py-24 bg-[#5B5843] text-white" id="support">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="text-center mb-16 loading">
            <h2 class="text-4xl md:text-5xl lg:text-6xl mb-6 text-white">Support Our Mission</h2>
            <p class="text-lg text-white/80 futura-400 max-w-3xl mx-auto leading-relaxed">
        ...
        <div class="grid md:grid-cols-3 gap-8 lg:gap-12 mb-16">
            ...
            <div class="text-center loading" style="animation-delay: {{ $index * 0.2 }}s">
                ...
                <h3 class="text-2xl mb-4 futura-500 text-white">{{ $way['title'] }}</h3>
                <p class="text-white/70 futura-400 leading-relaxed">{{ $way['description'] }}</p>
            </div>
            @endforeach
        </div>

        <!-- CTA Buttons -->
        <div class="flex flex-col sm:flex-row gap-6 justify-center items-center loading" style="animation-delay: 0.6s">
            <a href="#shop" class="inline-block bg-white text-[#252525] px-12 py-4 rounded-full text-sm tracking-widest uppercase futura-500 hover:bg-[#E4DDCC] transition-all duration-300 transform hover:scale-105">
                Start Shopping
            </a>
            <a href="#" class="inline-block bg-transparent border-2 border-white text-white px-12 py-4 rounded-full text-sm tracking-widest uppercase futura-500 hover:bg-white hover:text-[#252525] transition-all duration-300 transform hover:scale-105">
                Make a Donation
            </a>
        </div>

        <!-- Impact Statement -->
        <div class="mt-20 text-center loading" style="animation-delay: 0.8s">
            <blockquote class="text-2xl md:text-3xl italic text-white/90 max-w-4xl mx-auto leading-relaxed">
